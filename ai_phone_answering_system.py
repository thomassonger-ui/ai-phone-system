...
def process_speech():
    ...
    if conversation.should_escalate():
        ...
        response.say("I'm having trouble finding the answer. Let me take a message. Please speak after the tone.", voice='alice')
...
if __name__ == '__main__':
    ...
    load_dotenv()
    print("\n🤖 AI Phone System Starting...\n")
    print("Server: http://localhost:5000")
    print("\nNext: Use ngrok to expose to internet")
